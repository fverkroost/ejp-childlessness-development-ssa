...
dhs_gdl_regions <- data.frame(read_excel(
...
if (HIV == TRUE){
  ...
  hiv_gdl_regions <- data.frame(read_excel('data_files/hiv_gdl_dhs_regions_match.xlsx', col_types = "text", trim_ws = FALSE))
...
countries_africa <- read_excel('data_files/countriesAfrica.xlsx')
